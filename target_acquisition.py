...
def main():
    ...
    try:
        while True:
            ...
            # Weighted average to place the heart slightly below the shoulder center and above the hips
            heart_x = (shoulder_x + hip_x) / 2
            heart_y = (shoulder_y + hip_y) / 2

            # The heart is generally a little closer to the shoulders, so we adjust by favoring the shoulder
            heart_y = shoulder_y * 0.8 + hip_y * 0.2  # Adjust the weight as necessary (closer to 1 means higher up)
